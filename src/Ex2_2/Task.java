...
public class Task implements Callable<Object>, Comparable<Task> {
     ...
     * @return minus the difference between this tasks' priority and "other" task
     *         priority.
     *         low priority value is preferred. Thus, If the value returned > 0,
     *         this task is preferred,
     *         if value < 0, "other" task is preferred, and if value = 0, it doesn't
     *         matter.
     */
    @Override
